...
### Лабораторная 5:
*   Отслеживание активных сессий - знаем, какие устройства авторизованы;
*   Контроль refresh токенов - предотвращаем повторное использование;
*   Управление временем жизни - автоматическое истечение сессий;
*   Возможность принудительного выхода - отзыв всех сессий пользователя;
*   Четкая классификация состояний сессии;
*   Поиск по refresh токену - валидация при обновлении;
